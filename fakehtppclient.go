...
type ResponseConfig struct {
	// Responses that would be fetched by fake client for a continuous requests
...
// NewFakeHTTPClient returns a fake http client with the behaviour as configured in ResponseConfigMap
func NewFakeHTTPClient(responseMap ResponseConfigMap) (*http.Client, error) {
